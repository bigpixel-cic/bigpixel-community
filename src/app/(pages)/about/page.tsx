...
export default function AboutPage() {
  return (
    <div className="flex flex-col items-start gap-8 lg:gap-12">
      <article className="mx-auto prose md:prose-lg 2xl:prose-xl font-slab prose-headings:font-headline prose-h1:text-metal-950 prose-h1:font-black prose-metal dark:prose-invert dark:prose-h1:text-metal-50">
        <h1>
        ...
        <div className="not-prose mt-8 bg-purple-50 dark:bg-purple-800 rounded-xl p-6 lg:p-10 shadow-md">
          <div className="flex flex-col gap-4 text-lg lg:text-xl text-black dark:text-white">
            <p>
            ...
            <p className="text-sm lg:text-base font-bold font-sans text-purple-950 dark:text-purple-300">
